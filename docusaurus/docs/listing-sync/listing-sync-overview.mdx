---
title: Listing Sync – overview
sidebar_label: Listing Sync
description: Set up Listing Sync, connect Apple, understand statuses and reports, manage timelines, and resolve common issues.
tags: [listing-sync, apple-business-listings, accuracy-report, statuses, timeline, social-connections, service-area-businesses]
keywords: [listing-sync, connect-apple, listing-status, accuracy-report, category-column, last-update, refresh-listing, claimed-listing, stop-syncing, special-hours]
---
...
### Connect and authenticate Apple Business listing

You can connect and authenticate your Apple listing using a secure OAuth flow through Apple Business Connect. After connecting, your verified business data syncs automatically to Apple services.

#### Claim your Apple Business listing

Before connecting your listing, you must claim it through Apple Business Connect:

1. Visit [Apple Business Connect](https://businessconnect.apple.com/?campaignId=8018) and register for a free account.
2. Add your business location and address.
3. Enter business details, including category, phone number, and website.
4. Upload brand elements such as your logo, cover photo, and additional images.
5. Set your regular business hours.
6. Provide information about the organization that owns the business.
7. Complete verification by submitting a document such as a utility bill, business license, or lease agreement.

#### Connect via Local SEO

1. Open `Local SEO` and go to the `Listing Sync` tab.
2. Select the Apple card and click `Connect Now`.
3. Sign in with the email or phone number associated with Apple Business Connect.
4. Select the business entity to connect.
5. You will be redirected back, and syncing will complete.

![Sign in to Apple Business Connect](./img/Apple11.png)
![Select business entity](./img/Apple2.png)

#### Connect via business app

1. Open `Business App` and go to the `Administration` tab.
2. Select `Connections`, then choose `Apple Business Connect`.
3. Click `Add Connect` to begin authentication.
4. Sign in using the email or phone number associated with the account.
5. Select the business entity to connect.
6. You will return to the Apple Business Connect page once connected.

![Apple Business Connect card](./img/APPLE.png)
![Sign in to Apple Business Connect](./img/Apple3.png)
![Select business entity](./img/Apple4.png)
![Connection complete](./img/Apple5.png)

:::warning
Apple does not accept Service Area Businesses.
:::

## Apple Business listings

- **Data synchronization**: Your latest business information is sent to Apple.
- **Confidence score**: Apple uses a confidence score to determine data accuracy. Apple verifies data against your business website, so keep your website up to date before syncing.
- **Automatic updates**: Changes to your Business Profile push to Apple automatically.

![Apple card in Listing Sync](./img/apple-business-listings.jpg)

### Why Apple listings are important

- Increased visibility: Apple Maps is used by many people to find businesses.
- Accurate information: Correct details help customers find and trust your business.
- Enhanced features: You can add logos, cover images, and custom action links to help your listing stand out.
...
<details>
<summary>Does Apple accept Service Area Businesses?</summary>

No. Apple does not accept Service Area Businesses.

</details>

<details>
<summary>How do I connect my Apple listing?</summary>

Use the Apple card in Listing Sync to start the connection. Sign in to Apple Business Connect, select the entity, and complete the redirect back to finish.
