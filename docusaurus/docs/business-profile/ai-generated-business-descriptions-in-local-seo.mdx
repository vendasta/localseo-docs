...
![Local SEO Business Profile Marketing tab](./img/ai-business-desc-marketing-tab.jpg)

Click on the **Suggest Description** button.

![Suggest Description button](./img/ai-business-desc-suggest-button.jpg)
