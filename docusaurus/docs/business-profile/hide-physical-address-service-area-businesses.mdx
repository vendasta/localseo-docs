...
![Service Area Business option in account creation](./img/hide-address-service-area-1.jpg)
...
2. Click the menu icon next to **Create Account >** Select **Update Accounts (CSV Upload)**.
   ![Update Accounts option](./img/hide-address-update-accounts.jpg)
3. Upload a CSV file with the new data, either by first exporting a list to a CSV, or using the provided template.
   ...
   ![CSV Template with Service Area Business column](./img/hide-address-csv-template.jpg)
...
![Review changes screen](./img/hide-address-review-changes.jpg)
